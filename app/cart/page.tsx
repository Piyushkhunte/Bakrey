    ...
    return (
      <main className="min-h-screen bg-[#fffaf2] px-5 py-16 text-[#402b22]">
        <div className="mx-auto max-w-3xl text-center">
          <Link href="/" className="text-sm font-bold text-[#b64c2d] underline underline-offset-4">
            ← Back to bakery
          </Link>
          ...
          <p className="mt-3 text-[#76584a]">Add some fresh bakes and they will appear here.</p>
          <Link
            href="/#menu"
      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-4 font-display text-4xl sm:text-5xl">Your Cart</h1>
            <p className="mt-2 text-sm text-[#76584a]">Review your fresh bakes before checkout.</p>
          </div>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_360px]">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm font-bold text-[#c65334]">₹{item.price}</p>
                    </div>
          ...
          <aside className="h-fit rounded-3xl bg-[#4b2719] p-6 text-white lg:sticky lg:top-24">
            ...
            <h2 className="mt-2 font-display text-2xl">Almost ready!</h2>
